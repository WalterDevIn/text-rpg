...
export const ActionType = {
  ...
  CAST_DANCING_LIGHTS: "cast_dancing_lights",
  CAST_SHOCKING_GRASP: "cast_shocking_grasp",
  CAST_FALSE_LIFE: "cast_false_life",
  CAST_EXPEDITIOUS_RETREAT: "cast_expeditious_retreat",
...
export const gameState = {
  ...
  timeStopRemaining: 0,
  elapsedTime: 0,
  worldSeed: "palacio-infinito",
  loadedChunkKeys: [],
  exploredTilesByLayer: {},
};

...
import { gameState, EnemyState } from "../../engine/state/gameState.js";
import { getDistance, getDirection, moveEntityWithCollision, normalizeVector } from "../../engine/world/collision.js";
import { addItemToInventory } from "../items/inventory.js";
import { getItemDefinition, ItemId } from "../items/items.js";
import { hasWallNearPoint, isEntityVisibleToPlayer, isPointInMerchantSafeZone, isWallAt } from "../../engine/world/map.js";
import { rollDie } from "../../engine/rules/dice.js";
import { enemies } from "./enemy.js";
import { companions } from "../companions/companions.js";
import { spawnMagicMissileVolley } from "../../engine/projectiles/projectileSystem.js";
...
function updateMerchantCooldowns(merchant, deltaTime) {
  ...
  merchant.shieldRemaining = Math.max(0, (merchant.shieldRemaining ?? 0) - deltaTime);
  if (merchant.shieldRemaining <= 0) merchant.shieldHp = 0;
...
function moveMerchantByDirection(merchant, direction, deltaTime) {
  ...
  const speed = TILE_SIZE * 0.78 * getHiredMerchantAllyOverlapMultiplier(merchant);
